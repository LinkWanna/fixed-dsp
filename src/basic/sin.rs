...
const I16_SHIFT: i32 = 16 - 10;
const I32_SHIFT: i32 = 32 - 10;
...
pub fn sin_i16(x: i16) -> i16 {
    ...
    let index = ((x_bits as u32) >> I16_SHIFT) as usize;
    let fract = (x_mapped - ((index as i32) << I32_SHIFT)) << 9;
...
pub fn sin_i32(x: i32) -> i32 {
    ...
    let index = (x_bits >> I16_SHIFT) as usize;
    let fract = (x_mapped - ((index as i64) << I32_SHIFT)) << 9;
